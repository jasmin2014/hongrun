  ...
  <div class="Lending_Agreement_center">  
    <div class="lending_ageeement_tit">
      ...
      <span style="float:right; padding-right:10px;">
        <div @click="printht" style="color:#d92818;cursor:pointer;">【打印合同】</div> 
      </span>
    </div>
    <div class="ageeement_content">
      <p align="left">合同编号：<u><strong>20171030</strong></u> </p>
      <p align="left">甲方（投资人）：详见本协议第一条</p>
      <p align="left">乙方（借款人）：详见本协议第一条</p>
      <p align="left">担保方（丙方）：<u>温州宏润网络科技有限公司</u> </p>
      <!-- <p align="left" style="display: none;">生效日期：<u>1970年01月01日</u> </p> -->
      <p>&nbsp;</p>
      <p>借款人（乙方）通过由温州宏润网络科技有限公司创办的网络借贷中介平台  （http://www.zjhrgc.com） （以下简称“本平台”），向本平台的注册会员借款，该借款由担保方（丙方）为借款人（乙方）提供担保。相关借款事项根据《中华人民共和国合同法》等相关法律法规的规定，甲乙丙三方达成如下协议：</p>
      <p>&nbsp;</p>
      <strong class="font_lendig">第一条</strong>
      <p align="left">1、借款人信息：</p>
      <table  width="980" border="1px" bordercolor="#EEEEEE" cellspacing="0px" style="border-collapse:collapse;margin-top:20px;margin-left:10px;">
        <tr class="ageement_tab">
          <td width="196" height="40" align="center" valign="middle">平台账户</td>
      ...
      <table  width="980" border="1px" bordercolor="#EEEEEE" cellspacing="0px" style="border-collapse:collapse;margin-top:20px;margin-left:10px;">
        <tr class="ageement_tab">
          ...
          <td width="196" height="40" align="center" valign="middle">月截止日</td>
      ...
      <div class="Seal">
          丙方盖章：
          <img src="../assets/images/agreement.png" border="0" width="130px" height="130px">
          <br> 
          <p style="padding: 0px;"> 
            <b style="float: left;color: #666;">签署日期：</b>
            <span class="seal_text">2017年10月30日</span> 
          </p>
       </div>
    </div>
  </div>
